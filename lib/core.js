...
const { get, set } = require('./branch/config')
...
module.exports = {
    ...
    node: node,
    branch,
    transferFrom: (branchId, from, to, amount, password, net) => {
        return transferFrom(branchId, from, to, amount, password, net)
    },
    transfer: (branchId, to, amount, password, net) => {
        return transfer(branchId, to, amount, password, net)
    },
